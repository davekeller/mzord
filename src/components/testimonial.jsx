...
export default function Testimonial (props) {
  return (
    <div className="grid grid-cols-4 gap-12 text-right items-end">
      <div className="-mt-2 col-span-full flex-center space-x-4 pb-6 border-b-2 border-white text-center font-semibold text-qpWater">
      ...
      <img src="/assets/personas/testimonial.png" alt="avi" />
