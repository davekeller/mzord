...
export default function Cta() {
  return (
    <div className="card p-6 grid grid-cols-3 gap-8">
      <div className="p-4 h-32 bg-qpOrange-100 rounded-lg text-white font-bold text-lg leading-tight">
        Modelable Plan One
      </div>
      <div className="pl-6 col-span-2">
        <h1 className="font-bold text-lg">Single Rate Commission</h1>
