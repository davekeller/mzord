  ...
  return (
    <div className='fixed left-0 w-20 px-6 bg-qpDark h-screen'>
      <div className='py-8 flex-center flex-col space-y-6 text-center text-qpSlate-500 text-sm font-semibold'>
        ...
        <button 
          onClick={() => props.onChangePage('planList')}
          className="text-qpSlate-400 hover:text-qpSlate-200 space-y-1">
        ...
        <button 
          onClick={() => props.onChangePage('planList')}
          className="text-qpSlate-400 hover:text-qpSlate-200 pt-6 border-t border-gray-600 space-y-1">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <button 
          onClick={() => props.onChangePage('planList')}
          className="text-white hover:text-qpSlate-200 space-y-1 border-l-4 border-white px-6">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
