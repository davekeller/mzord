...
export default function Cta() {
  return (
    <div className="card p-6 flex border-4 border-transparent hover:border-qpSky cursor-pointer">
      <div className="p-4 w-32 h-32 bg-qpOrange-100 rounded-lg text-white font-semibold">
        <p className="font-bold">AE:</p>
        <p className="text-sm font-semibold leading-snug">Multi-Rate Plan</p>
      </div>
      <div className="pl-6">
        <h1 className="font-bold text-lg">Multi-Rate Commission</h1>
