      ...
      <div className='card p-12 pb-24 w-1/2 mx-auto'>
        ...
        <div className="mt-12 grid grid-cols-2 gap-12">
          <button 
            ...
            <svg className="mx-auto text-qpPurple-200" width="100" height="100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 className="text-xl mt-2 font-bold text-qpPurple-200">
